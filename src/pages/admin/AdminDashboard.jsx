        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3">
            {QUICK_ACTIONS.map(({ icon: Icon, label, sub, step, route, lightBg, border, text, gradient }) => (
              ...
              >
                {/* Hover gradient fill */}
                <div className={`absolute inset-0 bg-linear-to-br ${gradient} opacity-0 group-hover:opacity-5 transition-opacity duration-200 rounded-2xl`} />
 
                <div className="relative z-10 flex items-start gap-3">
            <div
              className={`w-10 h-10 rounded-xl bg-linear-to-br ${gradient} flex items-center justify-center shadow-sm shrink-0`}
            >
              <Icon size={20} className="text-white" />
                ...
                {/* Arrow indicator */}
                <div className={`absolute right-3 bottom-3 w-5 h-5 rounded-full bg-linear-to-br ${gradient} flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-200 translate-x-1 group-hover:translate-x-0`}>
